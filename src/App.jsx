...
//     // Teleport far away when clicked (like code 2 style)
...
//     alert("Almost had me... but nope! 😏 Keep trying~");
//   };

//   // Code 1 style fleeing - runs away when mouse gets close
//   useEffect(() => {
...
//           <h1>Yayyyy! 💖✨</h1>
//           <p className="main-text">I knew you would say Yes! 😍</p>
//           <p className="sub-text">You're officially mine forever now... no running away! 🫶</p>
//           <div className="floating-words">
//             <span style={{ animationDelay: '0.4s' }}>Forever</span>
//             <span style={{ animationDelay: '1.1s' }}>Yours</span>
//             <span style={{ animationDelay: '1.9s' }}>Always</span>
...
//       <p className="hint">
//         No is super fast and impossible to catch... just give up and say Yes already 😘
//       </p>
...
function App() {
  ...
  const handleYes = () => {
    setYesPressed(true);
    toast.success("YAYYY 💖 Best decision ever!", {
      position: "top-center",
      autoClose: 2000,
      theme: "colored",
    });
        ...
        <div className="yes-fullscreen">
          ...
          <div className="message-box">
            ...
            <p className="sub-text">
              You're officially mine forever now... no running away! 🫶
            </p>
